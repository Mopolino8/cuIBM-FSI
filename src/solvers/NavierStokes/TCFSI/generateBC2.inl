 ...
 */
template <>
void TCFSISolver<host_memory>::generateBC2()
{
	int  nx = domInfo->nx,
	     ny = domInfo->ny;
 ...
 */
template<>
void TCFSISolver<device_memory>::generateBC2()
{
	...
	real *uB,
	     *vB;
	//use ubk
	uB = thrust::raw_pointer_cast(&(B.uBk[0])),
	vB = thrust::raw_pointer_cast(&(B.vBk[0]));
