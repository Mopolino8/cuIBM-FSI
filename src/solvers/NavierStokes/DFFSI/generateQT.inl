 ...
 * \brief Implementation of the methods of the class \c DFFSI to generate
 ...
 */
template <>
void DFFSI<host_memory>::updateQ()
{
}
 ...
 *        This routine is specific to DFFSI.
 */
template <>
void DFFSI<device_memory>::updateQ()
{
...
void DFFSI<memoryType>::generateQT()
{
