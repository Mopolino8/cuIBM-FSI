 ...
 * \brief Implementation of the methods of the class \c DFFSI to tag
 ...
 */
template <>
void DFFSI<host_memory>::tagPoints()
{
 ...
 */
template <>
void DFFSI<device_memory>::tagPoints()
{
	logger.startTimer("tagPoints");
	...
	// transferring tag and coeffs data to the device //declared in DFFSI.h
	tagsD    = tags;
	tags2D   = tags2;
	coeffsD  = coeffs;
	coeffs2D = coeffs2;
...
void DFFSI<memoryType>::tagPoints(real *bx, real *by, real *uB, real *vB)
{
